...
export function Ajuda() {
  ...
  const itemsAccordion = [
    {
      título: "accordion1",
      textoAccordion: `Texto de teste.`,
    },
    {
      título: "accordion2",
      textoAccordion: `Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
...
culpa qui officia deserunt mollit anim id est laborum.`,
  ...
  const accordionFiltrado = itemsAccordion.filter(
    (a) =>
      a.textoAccordion.toLowerCase().indexOf(pesquisa.toLowerCase()) !== -1 ||
      a.título.toLowerCase().indexOf(pesquisa.toLowerCase()) !== -1
  );

  return (
    <div className={temaEscuro === 'dark' ? "principalAjuda" : ""}>
        ...
        <div className="row d-flex">
          <div className="input-group d-flex justify-content-center mb-3 mt-3">
            ...
            <input
              ...
              type="text"
              placeholder="Digite o termo procurado"
              onChange={getBusca}
            />
          </div>
        </div>
                ...
                return (
                  <Accordion defaultActiveKey="1" className="w-100 p-0">
                    <Accordion.Item eventKey="0">
                      <Accordion.Header className="acordeonItem w-100 p-0 ">
                        {accordion.título}
                      </Accordion.Header>
