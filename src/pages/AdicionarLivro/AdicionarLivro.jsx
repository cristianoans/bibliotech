...
export function AdicionarLivro() {
  ...
  return (
    <div className={temaEscuro === 'dark' ? "adicionar-livro" : ""}>
      <Container>
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Form.Group className="mb-3 mx-1">
                ...
                <Form.Control
                  ...
                  {...register("editora", {
                    ...
                    maxLength: {
                      value: 50,
                      message: "Limite de 50 caracteres!",
                    },
                  })}
                />
                <Form.Text className="invalid-feedback">
            ...
            >
              <Form.Control
                ...
                {...register("resumo", {
                  ...
                  maxLength: {
                    value: 2500,
                    message: "Limite de 2500 caracteres!",
                  },
                })}
              />
              <Form.Text className="invalid-feedback">
          ...
          <Button className={
              temaEscuro === "dark" ? "themeDark-btn mb-5" : "bg-success mb-5"
